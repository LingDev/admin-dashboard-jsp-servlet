<%-- 
    Document   : index1
    Created on : Apr 18, 2020, 2:25:54 AM
    Author     : vando
--%>
                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="/MasterServlet?redirect=DashBoardOverview" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Dashboard Overview
                                    </a>
                                    <a href="/MasterServlet?redirect=Students" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Students
                                    </a>
                                    <a href="/UsersServlet" class="mm-active">
                                        <i class="metismenu-icon pe-7s-rocket"></i>
                                        Users
                                    </a>
