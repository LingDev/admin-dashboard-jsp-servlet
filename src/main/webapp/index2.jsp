    ...
    <body>
        <div id="container">
            ...
            <div align="center" id="loginBox">
                <form action='LoginServlet' method="post" id="userform">
                    <fieldset style= "margin:auto; text-align:center">
                        <legend class="legend-bold" >Login</legend>
                        <div>					
                            <label>Username:</label>
                            <input class="theinput" type="text" placeholder= "Enter user name" name="userName" required/>
                        </div>
                        <div>
                            ...
                            <form action='RegisterServlet' method="post" id="regform">
                                <fieldset style= "margin:auto; text-align:center">
                                    ...
                                    <div>
                                        ...
                                        <input class="theinput" type="password" id="psword" name="password" placeholder="Enter Password" required/>
                                    </div>	
                                    <div>
                                        <label for="cfmpsword">Confirm Password</label> 
                                        <input class="theinput" type="password" id="cfmpsword" name="cfPassword" placeholder="Confirm Password" required/>
                                    </div> 
                                    <div>
                                        <label for="eml">First Name</label> 
                                        <input class="theinput" type="text" name="firstName" id="eml" placeholder="Enter First Name" required/>
                                    </div>			
                                    <div>
                                        <label for="eml">Last Name</label> 
                                        <input class="theinput" type="text" name="lastName" id="eml" placeholder="Enter Last Name" required/>
                                    </div>
                                    <div>
                                        <label for="eml">Phone</label> 
                                        <input class="theinput" type="text" name="phone" id="eml" placeholder="Enter Phone" required/>
                                    </div>
                                    <br>
